...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [navi1.tabBarItem setTitle:@"菜单列表"];
    
    UINavigationController *navi2 = [[UINavigationController alloc]initWithRootViewController:[[SecondViewController alloc]init]];
    [navi2.tabBarItem setTitle:@"侧边栏"];
    
    UINavigationController *navi3 = [[UINavigationController alloc]initWithRootViewController:[[ThirdViewController alloc]init]];
    [navi3.tabBarItem setTitle:@"待定"];
